...
echo "MODE: div_prune=$(grep -c 'def div_prune' $MODFILE) (expect 0)"

for TASK in pope mme mmbench_en_dev textvqa_val gqa seedbench; do
  ...
  accelerate launch --num_processes=1 -m lmms_eval \
    ...
    --log_samples --log_samples_suffix baseline_full \
